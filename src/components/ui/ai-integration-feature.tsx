...
export function AIIntegrationFeature({
    className,
}: {
    className?: string;
}) {
    ...
    return (
        <div
            className={cn(
                "relative flex h-[280px] md:h-[400px] w-full items-center justify-center overflow-hidden p-10",
                className,
            )}
            ref={containerRef}
        >
